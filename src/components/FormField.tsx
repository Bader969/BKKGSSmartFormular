...
export const FormField: React.FC<FormFieldProps> = props => {
  ...
  return <div className={`space-y-2 ${className}`}>
      ...
      <Input id={id} type={props.type} value={props.value} onChange={e => props.onChange(e.target.value)} placeholder={props.placeholder} disabled={disabled} className="bg-card" />
    </div>;
};